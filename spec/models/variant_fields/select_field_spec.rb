...
describe VariantFields::SelectField do
  ...
  context '#classification' do
    it 'should return the classification "select_field"' do
      Fabricate(:select_variant_field).classification.should == 'select_field'
    end
  end
  
  context '#options' do
    let(:field) do
      Fabricate(:select_variant_field, :options => ['Option 1', 'Option 2'])
    end
