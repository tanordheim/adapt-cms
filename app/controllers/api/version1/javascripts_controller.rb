...
class Api::Version1::JavascriptsController < Api::Version1::ApiController #:nodoc
  ...
  # Returns the serialization options to use for javascript collections. This
  ...
  # Returns the serialization options to use for javascript objects. This
  # filters out the design_id attribute.
  #
  # @returns [ Hash ] Hash of serialization options.
