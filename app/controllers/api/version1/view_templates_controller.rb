...
class Api::Version1::ViewTemplatesController < Api::Version1::ApiController #:nodoc
  ...
  # Returns the serialization options to use for view template collections.
  ...
  # Returns the serialization options to use for view template objects. This
