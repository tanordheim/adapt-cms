...
class Api::Version1::StylesheetsController < Api::Version1::ApiController #:nodoc
  ...
  # Returns the serialization options to use for stylesheet collections. This
  ...
  # Returns the serialization options to use for stylesheet objects. This
  # filters out the design_id attribute.
  #
  # @returns [ Hash ] Hash of serialization options.
